...
import { DEFAULT_ROUNDS, MAX_ROUNDS } from '@/constants/game.ts'
import {
  FLAG_ENOJIS,
...
const NumberInput = dynamic(() => import('../common/NumberInput/index.tsx'))
const Slider = dynamic(() => import('../common/Slider/index.tsx'))
const Switch = dynamic(() => import('../common/Switch/index.tsx'))
const Twemoji = dynamic(() => import('../Twemoji.tsx'))
