...
const GitHub = dynamic(() => import('../icons/GitHub.tsx'))
const LanguageSelect = dynamic(() => import('../LanguageSelect/index.tsx'))
const ThemeSelect = dynamic(() => import('../ThemeSelect/index.tsx'), {
  ssr: false,
})
