...
import { getLocations } from '@/actions/location.ts'
...
const BuilderMap = dynamic(() => import('@/components/BuilderMap/index.tsx'))
...
const MenuButton = dynamic(() => import('./menu-button.tsx'))
const SaveMapModal = dynamic(
  () => import('@/components/SaveMapModal/index.tsx'),
)
