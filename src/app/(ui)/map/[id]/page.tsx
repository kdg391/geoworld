...
import { getLike } from '@/actions/like.ts'
...
const DeleteButton = dynamic(() => import('./DeleteButton.tsx'))
const EditButton = dynamic(() => import('./EditButton.tsx'))
const LikeButton = dynamic(() => import('./LikeButton.tsx'))
const MapLeaderboard = dynamic(
  () => import('@/components/MapLeaderboard/index.tsx'),
)
const PlayButton = dynamic(() => import('./PlayButton.tsx'))
const Twemoji = dynamic(() => import('@/components/Twemoji.tsx'))
